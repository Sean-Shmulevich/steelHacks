...
<body class="overflow-y-scroll min-h-screen mb-20">
	...
	<!-- Hero Section -->
	<section
		class="bg-white bg-cover bg-center py-32 relative"
	...
	>
		<div class="absolute inset-0 bg-gray-900 bg-opacity-10" style="backdrop-filter: blur(4px);">
			<div
				class="container w-1/3 text-center mt-20 mx-auto border-gray-200 rounded-lg px-4 relative z-10"
			>
